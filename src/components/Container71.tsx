...
import ContainerComponent71 from "./ContainerComponent71";

const Container71: FunctionComponent = () => {
  return (
    <div className="absolute top-[314px] left-[114px] w-[1211px] h-[404px] text-left text-[13.55px] text-black font-poppins">
      <ContainerComponent71 />
      <ContainerComponent71 groupDivLeft="0px" />
      <div className="absolute top-[0px] left-[278px] w-[638px] h-[404px] text-xl">
        <div className="absolute top-[0px] left-[2px] w-[634.5px] h-[404px]">
          <img
            className="absolute top-[-4px] left-[-2.7px] w-[639.9px] h-[412px]"
            alt=""
            src="/group-10000086711.svg"
          />
          <div className="absolute top-[19px] left-[29px] w-[576px] h-[367px]">
            <div className="absolute top-[0px] left-[0px] w-[576px] h-[367px]">
              <img
                className="absolute top-[-10px] left-[-8.7px] rounded-3xs w-[593.4px] h-[387px]"
                alt=""
              ...
              <div className="absolute top-[195px] left-[51px] w-[293px] h-[34px]">
                <b className="absolute top-[8px] left-[0px] tracking-[2.83px] leading-[18px]">
                  Name :
                </b>
                <div className="absolute top-[8px] left-[137px] tracking-[2.83px] leading-[18px] font-semibold text-lightseagreen-200">
                  Rory McIlroy
                </div>
                <img
                  className="absolute top-[0px] left-[97px] rounded-[50%] w-[34px] h-[34px] object-cover"
                  alt=""
                  src="/ellipse-111@2x.png"
                />
              </div>
              <div className="absolute top-[260px] left-[43px] w-52 h-[50px] text-darkslategray-500">
                <div className="absolute top-[0px] left-[0px] w-52 h-[50px]">
                  <div className="absolute top-[0px] left-[0px] w-52 h-[50px]">
                    <b className="absolute top-[16px] left-[0px] tracking-[2.83px] leading-[18px]">
                      Total Par :
                    </b>
                    <div className="absolute top-[0px] left-[152px] w-14 h-[50px] text-21xl text-white">
                      <div className="absolute top-[0px] left-[0px] w-14 h-[50px]">
                        <div className="absolute top-[0px] left-[0px] w-14 h-[50px]">
                          <div className="absolute top-[0px] left-[0px] rounded-8xs bg-firebrick-200 shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] w-14 h-[50px]" />
                          <b className="absolute top-[16px] left-[8px] tracking-[2.83px] leading-[18px]">
                            71
                          </b>
                        </div>
                      </div>
              ...
              <div className="absolute top-[260px] left-[263px] w-[209px] h-[50px] text-darkslategray-500">
                <div className="absolute top-[0px] left-[0px] w-[209px] h-[50px]">
                  <div className="absolute top-[0px] left-[0px] w-[209px] h-[50px]">
                    <b className="absolute top-[16px] left-[0px] tracking-[2.83px] leading-[18px]">
                      Score Par :
                    </b>
                    <div className="absolute top-[0px] left-[153px] w-14 h-[50px] text-21xl text-white">
                      <div className="absolute top-[0px] left-[0px] w-14 h-[50px]">
                        <div className="absolute top-[0px] left-[0px] w-14 h-[50px]">
                          <div className="absolute top-[0px] left-[0px] rounded-8xs bg-lightseagreen-200 shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] w-14 h-[50px]" />
                          <b className="absolute top-[16px] left-[3px] tracking-[2.83px] leading-[18px]">
                            78
                          </b>
                        </div>
                      </div>
            ...
            <div className="absolute top-[50.9px] left-[278px] w-[231px] h-[124.9px] text-[7.89px] text-white font-body-b2">
              <div className="absolute top-[0px] left-[0px] w-[230px] h-[124.9px]">
                ...
                <img
                  ...
                  alt=""
                  src="/rectangle-531@2x.png"
                />
                <div className="absolute top-[16.6px] left-[105.1px] text-[9.86px] tracking-[-0.05px] leading-[5.91px] uppercase font-semibold text-darkturquoise-200 [-webkit-text-stroke:0.3px_#00eafe] [transform:_rotate(-3.95deg)] [transform-origin:0_0]">
                  Sarut Vongchaisit
                </div>
                ...
                <div className="absolute top-[83.1px] left-[138.3px] w-[51.9px] h-[20.7px]">
                  ...
                  <div className="absolute top-[1px] left-[31.2px] w-[19.7px] h-[19.7px] [transform:_rotate(-3deg)] [transform-origin:0_0] text-[11.83px]">
                    <div className="absolute top-[0px] left-[0px] w-[19.7px] h-[19.7px] [transform:_rotate(-3deg)] [transform-origin:0_0]">
                      <div className="absolute top-[0px] left-[0px] rounded-[0.99px] bg-crimson w-[19.7px] h-[19.7px] [transform:_rotate(-3deg)] [transform-origin:0_0]" />
              ...
              <div className="absolute top-[71.6px] left-[100.5px] rounded-[50%] bg-mediumslateblue [filter:blur(47.32px)] w-[48.6px] h-[48.6px]" />
              <div className="absolute top-[68px] left-[182.4px] rounded-[50%] bg-mediumslateblue [filter:blur(46.99px)] w-[48.6px] h-[48.6px]" />
            </div>
          </div>
        </div>
        <img
          className="absolute top-[164px] left-[-4px] w-[646px] h-[77px]"
          alt=""
          src="/group-1000008662.svg"
        />
      </div>
    </div>
  );
